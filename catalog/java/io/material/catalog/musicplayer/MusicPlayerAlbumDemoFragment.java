...
//
//      // Set the transition name which matches the list/grid item to be transitioned from for the shared element transition.
...
//    albumImage.setImageResource(album.getCover());
...
//    adapter.submitList(album.getTracks());
//  }
//
...
//        playingIcon.setVisibility(track.getPlaying() ? View.VISIBLE : View.INVISIBLE);
//        trackNumber.setText(String.valueOf(track.getTrack()));
